...
if (!isset($_GET['name']) || strlen($_GET['name']) < 1) {
    die('Name parameter missing'); // prints the message and exit the function
}
...
$human = isset($_POST["human"]) ? $_POST['human'] + 0 : -1; //Unable to understand
...
<head>
    <title>Rudra Rock, Paper, Scissors Game</title>
